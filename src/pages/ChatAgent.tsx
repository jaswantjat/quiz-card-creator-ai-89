          ...
          <div className="relative z-10 mb-12">
            <div className="flex flex-wrap gap-3">
              {[{
                ...
                <button
                  key={index}
                  className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-xl border border-orange-200/40 hover:bg-white/90 hover:shadow-lg hover:shadow-orange-500/10 transition-all duration-300 text-slate-700 hover:text-slate-800"
                >
